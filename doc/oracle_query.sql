...
COMMENT ON COLUMN "TB_BOARD"."BOARD_NO" IS '게시물 번호';
...
CREATE SEQUENCE "TB_BOARD_SEQ"  MINVALUE 1 MAXVALUE 999999999999 INCREMENT BY 1 START WITH 1 CACHE 100 NOORDER  NOCYCLE ;
