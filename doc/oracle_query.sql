...
insert into TB_POWEWRNOTEBOARD_COMMENT ( COMMENT_NO, POST_NO, COMMENT_GNO, COMMENT_GORD, COMMENT_DEPTH, PAR_USER_NO, PAR_USER_WRITER, USER_NO, WRITER, CONTENT,  REG_DATE, UPT_DATE )
values ( TB_POWEWRNOTEBOARD_COMMENT_SEQ.nextval, 4, 1, 0, 0, 0, ' ', 1, '파워킴', '첫번째글 ', SYSDATE, SYSDATE );

insert into TB_POWEWRNOTEBOARD_COMMENT ( COMMENT_NO, POST_NO, COMMENT_GNO, COMMENT_GORD, COMMENT_DEPTH, PAR_USER_NO, PAR_USER_WRITER, USER_NO, WRITER, CONTENT,  REG_DATE, UPT_DATE )
values ( TB_POWEWRNOTEBOARD_COMMENT_SEQ.nextval, 4, 2, 0, 0, 0, ' ', 2, '김병현', '두번째댓글', SYSDATE, SYSDATE );

insert into TB_POWEWRNOTEBOARD_COMMENT ( COMMENT_NO, POST_NO, COMMENT_GNO, COMMENT_GORD, COMMENT_DEPTH, PAR_USER_NO, PAR_USER_WRITER, USER_NO, WRITER, CONTENT,  REG_DATE, UPT_DATE )
values ( TB_POWEWRNOTEBOARD_COMMENT_SEQ.nextval, 4, 3, 0, 0, 0, ' ', 2, '김병현', '세번째댓글', SYSDATE, SYSDATE );

insert into TB_POWEWRNOTEBOARD_COMMENT ( COMMENT_NO, POST_NO, COMMENT_GNO, COMMENT_GORD, COMMENT_DEPTH, PAR_USER_NO, PAR_USER_WRITER, USER_NO, WRITER, CONTENT,  REG_DATE, UPT_DATE )
values ( TB_POWEWRNOTEBOARD_COMMENT_SEQ.nextval, 4, 3, 1, 1, 1, '파워킴', 2, '김병현', '세번째댓글->댓글1', SYSDATE, SYSDATE );

insert into TB_POWEWRNOTEBOARD_COMMENT ( COMMENT_NO, POST_NO, COMMENT_GNO, COMMENT_GORD, COMMENT_DEPTH, PAR_USER_NO, PAR_USER_WRITER, USER_NO, WRITER, CONTENT,  REG_DATE, UPT_DATE )
values ( TB_POWEWRNOTEBOARD_COMMENT_SEQ.nextval, 4, 3, 2, 1, 1, '파워킴', 2, '김병현', '세번째댓글->댓글2', SYSDATE, SYSDATE );

insert into TB_POWEWRNOTEBOARD_COMMENT ( COMMENT_NO, POST_NO, COMMENT_GNO, COMMENT_GORD, COMMENT_DEPTH, PAR_USER_NO, PAR_USER_WRITER, USER_NO, WRITER, CONTENT,  REG_DATE, UPT_DATE )
values ( TB_POWEWRNOTEBOARD_COMMENT_SEQ.nextval, 4, 3, 3, 1, 1, '파워킴', 2, '김병현', '세번째댓글->댓글3', SYSDATE, SYSDATE );

insert into TB_POWEWRNOTEBOARD_COMMENT ( COMMENT_NO, POST_NO, COMMENT_GNO, COMMENT_GORD, COMMENT_DEPTH, PAR_USER_NO, PAR_USER_WRITER, USER_NO, WRITER, CONTENT,  REG_DATE, UPT_DATE )
values ( TB_POWEWRNOTEBOARD_COMMENT_SEQ.nextval, 4, 3, 4, 2, 1, '파워킴', 2, '김병현', '세번째댓글->댓글2->댓글1', SYSDATE, SYSDATE );

insert into TB_POWEWRNOTEBOARD_COMMENT ( COMMENT_NO, POST_NO, COMMENT_GNO, COMMENT_GORD, COMMENT_DEPTH, PAR_USER_NO, PAR_USER_WRITER, USER_NO, WRITER, CONTENT,  REG_DATE, UPT_DATE )
values ( TB_POWEWRNOTEBOARD_COMMENT_SEQ.nextval, 4, 4, 0, 0, 0, ' ', 2, '김병현', '네번째댓글', SYSDATE, SYSDATE );

insert into TB_POWEWRNOTEBOARD_COMMENT ( COMMENT_NO, POST_NO, COMMENT_GNO, COMMENT_GORD, COMMENT_DEPTH, PAR_USER_NO, PAR_USER_WRITER, USER_NO, WRITER, CONTENT,  REG_DATE, UPT_DATE )
values ( TB_POWEWRNOTEBOARD_COMMENT_SEQ.nextval, 4, 2, 1, 1, 1, '파워킴', 2, '김병현', '두번째댓글->댓글1', SYSDATE, SYSDATE );

insert into TB_POWEWRNOTEBOARD_COMMENT ( COMMENT_NO, POST_NO, COMMENT_GNO, COMMENT_GORD, COMMENT_DEPTH, PAR_USER_NO, PAR_USER_WRITER, USER_NO, WRITER, CONTENT,  REG_DATE, UPT_DATE )
values ( TB_POWEWRNOTEBOARD_COMMENT_SEQ.nextval, 4, 2, 2, 1, 1, '파워킴', 2, '김병현', '두번째댓글->댓글2', SYSDATE, SYSDATE );
